...
export function AdminShell({ user, children }: AdminShellProps) {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      <aside
        className={cn(
          'fixed left-0 top-0 z-50 flex h-full w-64 flex-col border-r bg-card shadow-xl transition-transform duration-300 md:static md:z-30 md:w-60 md:translate-x-0 md:shadow-none',
